...
# 10  map          60142 non-null  int64
      ...
      #  age_rounded = float(round(age_years))
       ...
       # print(map)
        ...
        last_row_dict = df.tail(1)
                # Insérer une valeur None dans la colonne "cardio" de la dernière ligne
        last_row_dict.loc[last_row_dict.index[-1], 'cardio'] = None
        last_row_dict=last_row_dict.to_dict(orient='records')[0]
